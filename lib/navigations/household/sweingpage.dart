...
class sweingpage extends StatefulWidget {
  const sweingpage({Key? key}) : super(key: key);
  @override
  State<sweingpage> createState() => _sweingpageState();
}

var price = 1313;
var text = 1;

class _sweingpageState extends State<sweingpage> {
  @override
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                ...
                "•Complimentary Sewing lessons can be accessed through Usha Store. Click on the Usha Store available above the ratings\n "
