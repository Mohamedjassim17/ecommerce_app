...
class mosquitopage extends StatefulWidget {
  const mosquitopage({Key? key}) : super(key: key);

  @override
  State<mosquitopage> createState() => _mosquitopageState();
}
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                "•Quantity: Contains 1 All Out Machine + 1 Refill of 45ml\n"
                "•The All Out Ultra Power Slider machine has a unique adjustable slider that gives you 100%\n"
