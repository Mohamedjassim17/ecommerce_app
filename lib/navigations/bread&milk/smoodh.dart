...
class smoodh extends StatefulWidget {
  const smoodh({Key? key}) : super(key: key);

  @override
  State<smoodh> createState() => _smoodhState();
}

var text = 1;
var price = 601;

class _smoodhState extends State<smoodh> {
  @override
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                ...
                "•Shake Well Before Consuming, Tastes Best When Chilled\n"
                "•Pack of 40\n",
                style: TextStyle(
