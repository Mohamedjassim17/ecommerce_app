...
class pannerphool extends StatefulWidget {
  const pannerphool({Key? key}) : super(key: key);

  @override
  State<pannerphool> createState() => _pannerphoolState();
}

var text = 1;
var price = 863;

class _pannerphoolState extends State<pannerphool> {
  @override
