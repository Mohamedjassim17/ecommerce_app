...
class everestmasala extends StatefulWidget {
  const everestmasala({Key? key}) : super(key: key);

  @override
  State<everestmasala> createState() => _everestmasalaState();
}

var text = 1;
var price = 43;

class _everestmasalaState extends State<everestmasala> {
  @override
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Image.asset("images/meats/everest masala.jpg", height: 250),
          ),
          Container(
            height: 90,
