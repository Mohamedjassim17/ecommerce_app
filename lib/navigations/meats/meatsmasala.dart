...
class meatsmasala extends StatefulWidget {
  const meatsmasala({Key? key}) : super(key: key);

  @override
  State<meatsmasala> createState() => _meatsmasalaState();
}

var text = 1;
var price = 84;

class _meatsmasalaState extends State<meatsmasala> {
  @override
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Image.asset("images/meats/meatmasala-removebg-preview.png",
                height: 250),
          ),
          Container(
            height: 90,
