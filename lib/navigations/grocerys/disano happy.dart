...
class disanohappy extends StatefulWidget {
  const disanohappy({Key? key}) : super(key: key);

  @override
  State<disanohappy> createState() => _disanohappyState();
}

var text = 1;
var price = 129;

class _disanohappyState extends State<disanohappy> {
  @override
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                ...
                "•Container Type: Jar; Material Features: Vegetarian;\n "
                "•A unique blend of Sunderban Honey & Tulsi made indigenously;.\n "
                "•high quality,\n",
                style: TextStyle(
