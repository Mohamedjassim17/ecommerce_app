...
class cashews extends StatefulWidget {
  const cashews({Key? key}) : super(key: key);

  @override
  State<cashews> createState() => _cashewsState();
}

var text = 1;
var price = 1200;

class _cashewsState extends State<cashews> {
  @override
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Image.asset("images/grocery/Cashews-removebg-preview.png",
                height: 250),
          ),
          Container(
            height: 90,
