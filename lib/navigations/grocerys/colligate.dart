...
class colagate extends StatefulWidget {
  const colagate({Key? key}) : super(key: key);

  @override
  State<colagate> createState() => _colagateState();
}

var text = 1;
var price = 973;

class _colagateState extends State<colagate> {
  @override
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Image.asset("images/grocery/colgate-removebg-preview.png",
                height: 250),
          ),
          Container(
            height: 90,
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                "•It is a red gel with cooling crystals that provide intense freshness. This pack has 4 x 150g tubes.\n"
