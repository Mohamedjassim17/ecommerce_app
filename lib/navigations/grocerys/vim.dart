...
class vim extends StatefulWidget {
  const vim({Key? key}) : super(key: key);

  @override
  State<vim> createState() => _vimState();
}

var text = 340;
var price = 1;

class _vimState extends State<vim> {
  @override
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Image.asset("images/grocery/vim-removebg-preview.png",
                height: 250),
          ),
          Container(
            height: 90,
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                ...
                "•surface_recommendation: Tableware, Cookware\n "
