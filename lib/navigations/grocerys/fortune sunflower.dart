...
class fortunesunflower extends StatefulWidget {
  const fortunesunflower({Key? key}) : super(key: key);

  @override
  State<fortunesunflower> createState() => _fortunesunflowerState();
}

var price = 510;
var text = 1;

class _fortunesunflowerState extends State<fortunesunflower> {
  @override
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: Text(
                "•SCCA; Light and healthy that is easy to digest.\n"
