...
class maggic extends StatefulWidget {
  const maggic({Key? key}) : super(key: key);

  @override
  State<maggic> createState() => _maggicState();
}

var text = 1;
var price = 129;

class _maggicState extends State<maggic> {
  @override
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Image.asset("images/grocery/maggic-removebg-preview.png",
                height: 250),
          ),
          Container(
            height: 90,
